...
public class Adapter_Summery extends RecyclerView.Adapter<Adapter_Summery.ViewHolder> {
    ...
    public void setSummeryList(List<Model_quiz_history> cartItems) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        final Model_quiz_history model = quizAnswer_m_gets.get(position);
