...
public class Model_quiz_history {
    ...
    DiffUtil.ItemCallback<Model_quiz_history> itemCallback = new DiffUtil.ItemCallback<Model_quiz_history>() {
        @Override
        public boolean areItemsTheSame(@NonNull @NotNull Model_quiz_history oldItem, @NonNull @NotNull Model_quiz_history newItem) {
            return oldItem.getQuiz_question_id() == newItem.getQuiz_question_id();
        }

        @Override
        public boolean areContentsTheSame(@NonNull @NotNull Model_quiz_history oldItem, @NonNull @NotNull Model_quiz_history newItem) {
            return oldItem.equals(newItem);
        }
    };

    public Model_quiz_history(String quiz_question_id, String quiz_answer_id, String quiz_question, String correct_status, int postion) {
    ...
    public boolean equals(Object o) {
        ...
        Model_quiz_history that = (Model_quiz_history) o;
